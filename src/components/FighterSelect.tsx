...
export default function FighterSelect() {
  const [selectedId, setSelectedId] = useState<string>('protagonist');

  const selectedFighter = fightersData.find(f => f.id === selectedId) || fightersData[0];
  ...
  return (
    <div className="space-y-8" id="fighter-select-section">
      {/* Header */}
      <div className="border-b-2 border-zinc-800 pb-4">
        <h2 className="font-display text-2xl font-black tracking-wider text-[#FF2E2E] uppercase text-shadow-neon-pink flex items-center gap-2">
          <Zap className="text-[#FF2E2E] w-6 h-6 animate-pulse" />
          Fighter Select: Elenco de Personajes
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 flex flex-col justify-start space-y-4">
          ...
          <button
            ...
            className="w-full py-2.5 mt-2 font-display text-xs tracking-wider bg-zinc-950 hover:bg-zinc-900 text-[#00E5FF] border-2 border-zinc-800 hover:border-[#00E5FF] rounded-none transition-all duration-300 flex items-center justify-center gap-2"
          >
        ...
        <div className="lg:col-span-8">
          <motion.div
            ...
            className="bg-zinc-950 border-4 border-zinc-800 rounded-none p-6 grid grid-cols-1 md:grid-cols-2 gap-8 relative"
            id="fighter-profile-sheet"
          >
            {/* Fighter description Column */}
            <div className="space-y-4">
              <div>
                <span className="font-arcade text-[8px] tracking-widest text-[#FF2E2E] uppercase">
                  CHARACTER PORTFOLIO // STATS SHEET
                </span>
              ...
              <div className="p-3 bg-[#111] border-2 border-zinc-800 rounded-none space-y-1">
                <div className="flex items-center gap-1.5">
                  <span className="text-[#FF2E2E] font-arcade text-[9px] animate-pulse">SPECIAL ABILITY:</span>
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <span className="text-[10px] font-display text-zinc-500 uppercase tracking-widest font-black">
                  CHARACTER STATS / VALORES EXISTENCIALES:
                </span>
                <div className="space-y-2">
              ...
              <div className="space-y-2 pt-2 border-t-2 border-zinc-800/60">
                <span className="text-[10px] font-display text-zinc-500 uppercase tracking-widest flex items-center gap-1 font-black">
                  <Swords className="w-3.5 h-3.5 text-[#FF2E2E]" />
